...
Transaction.prototype.toObject = Transaction.prototype.toJSON = function toObject() {
  ...
  if (!_.isUndefined(this._fee)) {
  	this._fee = this._fee < 10000 ? 10000 : this._fee;
    obj.fee = this._fee;
  }
  return obj;
};
...
Transaction.prototype.fromObject = function fromObject(arg) {
  ...
  _.each(transaction.inputs, function(input) {
    ...
    var txin;
    if (script.isPublicKeyHashOut() || script.isColdStakingOut()) {
...
Transaction.prototype._fromNonP2SH = function(utxo) {
  ...
  if (utxo.script.isPublicKeyHashOut() || utxo.script.isColdStakingOut()) {
...
Transaction._estimateFee = function(size, amountAvailable, feePerKb) {
  ...
  fee = fee < 10000 ? 10000 : fee;
  fee = Math.ceil(fee / 10000) * 10000; // round up to nearest 10000
